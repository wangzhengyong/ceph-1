...
class C_AioCompareExtentRequest: public C_AioRequest {
public:
	C_AioCompareExtentRequest(AioCompletion *completion):
		C_AioRequest(completion) { }
	~C_AioCompareExtentRequest() override {}
